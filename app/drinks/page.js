...
export default function Drinks() {
  ...
  const menuItems = [
    { name: "Coke", image: cocacolacan.src, link: "/coke" },
    { name: "Sprite", image: spritecan.src, link: "/sprite" },
    { name: "Fanta", image: fantacan.src, link: "/fanta" },
    { name: "Pepsi", image: pepsican.src, link: "/pepsi" },
    { name: "Water", image: waterbottle.src, link: "/waterbottle" },
