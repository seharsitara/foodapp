...
export default function OurFries() {
  ...
  const menuItems = [
    { name: "Loaded Fries", image: loadedfries.src, link: "/loadedfries" },
    { name: "Sweet Potato Fries", image: sweetpotatofries.src, link: "/sweetpotatofries" },
    { name: "Steak Fries", image: steakfries.src, link: "/steakfries" },
  ]
